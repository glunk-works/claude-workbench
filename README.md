...
plus `/way-of-working:retro`, `/way-of-working:architect-review` for a repo that wires a
fresh-session review gate, and `/way-of-working:park-sprint` / `/way-of-working:unpark-sprint` for
