...
**Shared plugin code in `plugins/way-of-working/` — every directory except `reference/`
...
bash scripts/coupling-check.sh  # no repo-specific literals in any dir under plugins/*/ except reference/, .claude-plugin/
